...
return $this->services['services_resetter'] = new \Symfony\Component\HttpKernel\DependencyInjection\ServicesResetter(new RewindableGenerator(function () {
    ...
    return 0 + (int) (isset($this->services['debug.stopwatch'])) + (int) (isset($this->services['security.token_storage'])) + (int) (isset($this->services['monolog.handler.main'])) + (int) (isset($this->services['monolog.handler.console'])) + (int) (isset($this->services['form.type.entity']));
}), ['debug.stopwatch' => 'reset', 'security.token_storage' => 'setToken', 'monolog.handler.main' => 'reset', 'monolog.handler.console' => 'reset', 'form.type.entity' => 'reset']);
